      ...
      <View style={styles.container}>
        ...
        <View style={styles.totalRate}>
          ...
          <View style={styles.individualRateGroup}>
            <RatingProgreeBar
              style={{ width: mainWidth, height: 25 }}
              width={mainWidth}
              title={this.props.rateTitle0}
              rate={this.props.rateVal0}
            />
            <RatingProgreeBar
              style={{ width: mainWidth, height: 25 }}
              width={mainWidth}
              title={this.props.rateTitle1}
              rate={this.props.rateVal1}
            />
            <RatingProgreeBar
              style={{ width: mainWidth, height: 25 }}
              width={mainWidth}
              title={this.props.rateTitle2}
              rate={this.props.rateVal2}
            />
          </View>
          <View style={styles.individualRateGroup}>
            <RatingProgreeBar
              style={{ width: mainWidth, height: 25 }}
              width={mainWidth}
              title={this.props.rateTitle3}
              rate={this.props.rateVal3}
            />
            <RatingProgreeBar
              style={{ width: mainWidth, height: 25 }}
              width={mainWidth}
              title={this.props.rateTitle4}
              rate={this.props.rateVal4}
            />
            <RatingProgreeBar
              style={{ width: mainWidth, height: 25 }}
              width={mainWidth}
              title={this.props.rateTitle5}
              rate={this.props.rateVal5}
            />
          </View>
        </View>
          ...
          <View style={styles.ratingConatiner}>
            ...
            <StarRatings
              ...
              filledStarImage={
                <Image
                  style={styles.rateImage}
                  source={require("../../../../assets/empty-star-full.png")}
                />
              }
            />
          </View>
        ...
        >
          <Text style={styles.normalText}>{this.props.clientDescription}</Text>
        </ReadMoreView>
        <TouchableOpacity>
          <Text style={styles.more}>
            Read all {this.props.reviewNum} reviews
          </Text>
        </TouchableOpacity>
      </View>
    );
