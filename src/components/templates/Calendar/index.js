...
export default class Calendar extends Component {
  ...
  resetCalendar() {
    ...
    const isStartValid =
      start.isValid() && start >= this.minDate && start <= this.maxDate;
    const isEndValid =
      end.isValid() && end >= this.minDate && end <= this.maxDate;
    this.setState({
      startDate: isStartValid ? start : null,
      startDateText: isStartValid ? this.i18n(start, "date") : "",
      startWeekdayText: isStartValid
        ? this.i18n(start.isoWeekday(), "weekday")
        : "",
  ...
  i18n(data, type) {
    try {
      ...
      processError(`[Calendar(template)::i18n] ${error.message}`, {
        error,
        type,
        data
      });
  ...
  render() {
    ...
    const { mainColor, subColor, borderColor, primaryColor } = this.props.color;
        ...
        <View style={[styles.container, mainBack]}>
          ...
          <View style={styles.result}>
            <View style={styles.resultPart}>
              ...
              <Text
                style={[styles.resultText, styles.startText, primaryFontColor]}
              >
            ...
            <View style={styles.resultPart}>
              ...
              <Text
                style={[styles.resultText, styles.endText, primaryFontColor]}
              >
