...
class HomeDetailBottomBar extends Component {
  ...
  _didFocus() {
    ...
    if (
      ...
      !HomeDetailBottomBar.self.state.isLocPriceRendered
    ) {
      HomeDetailBottomBar.self.state.isLocPriceRendered = true;
      WebsocketClient.sendMessage(
        HomeDetailBottomBar.self.state.fiatInEur,
        null,
        { fiatAmount: HomeDetailBottomBar.self.state.fiatInEur },
        true
      );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withNavigation(HomeDetailBottomBar));
