...
class HotelDetailBottomBar extends Component {
  ...
  _didFocus() {
    ...
    if (
      ...
      !HotelDetailBottomBar.self.state.isLocPriceRendered
    ) {
      HotelDetailBottomBar.self.state.isLocPriceRendered = true;
      WebsocketClient.sendMessage(
        HotelDetailBottomBar.self.state.fiatInEur,
        null,
        { fiatAmount: HotelDetailBottomBar.self.state.fiatInEur },
        true
      );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withNavigation(HotelDetailBottomBar));
