          ...
          <View>
            <View style={styles.navItem}>
              <View>
                ...
                <Text style={styles.navText}>
                  Receive messages from hotels and guests
                </Text>
              </View>
            </View>
            ...
            <View style={styles.navItem}>
              ...
              <View>
                ...
                <Switch
                  ...
                  onChangeValue={() => {
                    userInstance.setMessageEmailNotification(
                      !recieveEmailMessage
                    );
                    this.setState({
                      recieveEmailMessage: !recieveEmailMessage
                    });
                  ...
                  switchWidth={62}
                  switchBorderColor={
                    recieveEmailMessage ? "#e4a193" : "#cccccc"
                  }
                  switchBorderWidth={1}
                  buttonWidth={30}
                  buttonHeight={30}
            ...
            <View style={styles.navItem}>
              ...
              <View>
                ...
                <Switch
                  ...
                  onChangeValue={() => {
                    userInstance.setMessageTextNotification(
                      !recieveTextMessage
                    );
            ...
            <View style={styles.navItem}>
              ...
              <View>
                ...
                <Switch
                  ...
                  onChangeValue={() => {
                    userInstance.setMessagePushNotification(
                      !recievePushNotificationMessages
                    );
                    this.setState({
                      recievePushNotificationMessages: !recievePushNotificationMessages
                    });
                    setTimeout(() => this.setState({ checkZIndex: 1 }), 150);
                  }}
                  activeTextColor="#FFF"
                  ...
                  switchWidth={62}
                  switchBorderColor={
                    recievePushNotificationMessages ? "#e4a193" : "#cccccc"
                  }
                  switchBorderWidth={1}
                  buttonWidth={30}
                  buttonHeight={30}
            ...
            <View style={styles.navItem}>
              <View>
                ...
                <Text style={styles.navText}>
                  Receive reminders, helpful tips to improve your trip and other
                  messages related to your activites on Locktrip.
                </Text>
              </View>
            </View>
            <View style={styles.navItem}>
            ...
            <View style={styles.navItem}>
              ...
              <View>
                ...
                <Switch
                  ...
                  onChangeValue={() => {
                    userInstance.setReminderPushNotification(
                      !recievePushNotification
                    );
                    this.setState({
                      recievePushNotification: !recievePushNotification
                    });
                    setTimeout(() => this.setState({ checkZIndex: 1 }), 150);
                  }}
                  activeTextColor="#FFF"
                  ...
                  switchWidth={62}
                  switchBorderColor={
                    recievePushNotification ? "#e4a193" : "#cccccc"
                  }
                  switchBorderWidth={1}
                  buttonWidth={30}
                  buttonHeight={30}
