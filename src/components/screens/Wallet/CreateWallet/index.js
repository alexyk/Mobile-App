...
class CreateWallet extends Component {
  ...
  async submitPassword() {
    ...
    if (
      ...
      Toast.showWithGravity(
        "Passwords are not matched, Please input correctly.",
        Toast.SHORT,
        Toast.BOTTOM
      );
      return;
      ...
      >
        ...
        <View style={styles.container}>
          ...
          <View style={styles.main}>
            ...
            <View>
              <Text style={styles.infoText}>
                Your LOC wallet is Blockchain based and you are the only person
                to have access to it. It will not be on our server. When you are
                adding funds to it, your funds will be in your complete control
                and possession. It is very important not to share your wallet
                password. For security reasons we will not store this password
                and there will be no way for you to recover it through our site.
              </Text>
            </View>

            <View style={styles.titleView}>
              <Text style={styles.titleText1}>
                Please create your LOC wallet
              </Text>
            </View>
            ...
            <View style={styles.titleView}>
              <Text style={styles.titleText2}>
                Please confirm your LOC wallet
              </Text>
            </View>
          ...
          <LineProgressDialog
            ...
            title=""
            message={
              "Creating Wallet: " + parseInt(this.state.progress * 100) + "%"
            }
