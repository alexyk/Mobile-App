            ...
            <View style={styles.main}>
              ...
              <View>
                <Text style={styles.infoText}>
                  Your mnemonic recovery keywords are the ONLY WAY you could
                  recover access to your wallet in case your device is damaged
                  and/or in case you forget your wallet password. You should
                  write them down on a piece of paper and store them in a safe
                  place where no one else has access to.
                </Text>
              </View>
