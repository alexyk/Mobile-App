      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.residenceView}>
            <TouchableOpacity
              onPress={() => this.setState({ isHotelSelected: false })}
              style={[
                styles.residence,
            ...
            >
              ...
              <Image
                source={require("../../../assets/png/Filters/home.png")}
          ...
          <View style={styles.residenceView}>
            <TouchableOpacity
              onPress={() => this.setState({ isHotelSelected: true })}
              style={[
                styles.residence,
                this.state.isHotelSelected ? styles.selected : ""
              ]}
          ...
          <View style={{ height: "100%" }}>
            ...
            >
              ...
              <View
                style={
                  this.state.isHotelSelected
                    ? [styles.group, styles.borderBottom]
                    : styles.emptyPricingView
                }
              >
                <View style={styles.type}>
                ...
                <View style={styles.countView}>
                  <TouchableOpacity
                    style={[
                      styles.minusButton,
                      this.state.count.bedrooms === 0 ? styles.opacity : ""
                    ]}
                    onPress={() => this.subtractCount(1)}
                  >
                    <Text style={styles.minusText}>-</Text>
                  </TouchableOpacity>
                  <Text style={styles.countText}>
                    {this.state.count.bedrooms}
                  </Text>
                  <TouchableOpacity
                    style={styles.plusButton}
                    onPress={() => this.addCount(1)}
                  >
                    <Text style={styles.plusText}>+</Text>
                  </TouchableOpacity>
                </View>
