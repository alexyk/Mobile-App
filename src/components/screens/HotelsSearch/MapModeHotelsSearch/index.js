...
import { log, reactotronLoggingInReleaseForceEnabled } from '../../../../config-debug';
    ...
    renderCalloutStars = ({stars}) => {
        ...
        if (stars != null) {
            ...
            try {
                ...
                console.warn(`[MapModeHotelsSearch] Error rendering stars in callout: ${error.message}`,{error});
            }
        }
        return result;
    }
