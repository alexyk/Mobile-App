...
import styles, {
  orderbyPickerSelectStyles,
  priceMultiSliderStyle
} from "./styles";
...
class HotelFilters extends Component {
  ...
  onFilter = () => {
    ...
    setTimeout(() => func(state, true), 300);
  };
    ...
    return (
      <View style={styles.residenceView}>
        <TouchableOpacity
          style={[
            styles.residence,
            this.state.isHotelSelected ? styles.selected : ""
          ]}
        >
          ...
          <Image
            source={require("../../../../assets/png/Filters/hotel.png")}
      ...
      <View style={styles.starRatingView}>
        ...
        <View style={styles.starView}>
          <TouchableOpacity
            style={[
              styles.starBox,
              this.state.selectedRating[0] === true ? styles.activeRating : ""
            ]}
            onPress={() =>
              this.handleRatingChange(
                0,
                this.state.selectedRating[0] ? false : true
              )
            }
          >
            <Text
              style={[
                styles.ratingNumber,
                this.state.selectedRating[0] === true
            ...
            <Image
              source={require("../../../../assets/png/empty-star.png")}
              style={styles.star}
            />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={[
              styles.starBox,
              this.state.selectedRating[1] === true ? styles.activeRating : ""
            ]}
            onPress={() =>
              this.handleRatingChange(
                1,
                this.state.selectedRating[1] ? false : true
              )
            }
          >
            <Text
              style={[
                styles.ratingNumber,
                this.state.selectedRating[1] === true
                  ? styles.activeRatingText
                  : ""
              ]}
            >
          ...
          <TouchableOpacity
            style={[
              styles.starBox,
              this.state.selectedRating[2] === true ? styles.activeRating : ""
            ]}
            onPress={() =>
              this.handleRatingChange(
                2,
                this.state.selectedRating[2] ? false : true
              )
            }
          >
            <Text
              style={[
                styles.ratingNumber,
                this.state.selectedRating[2] === true
                  ? styles.activeRatingText
                  : ""
              ]}
            >
          ...
          <TouchableOpacity
            style={[
              styles.starBox,
              this.state.selectedRating[3] === true ? styles.activeRating : ""
            ]}
            onPress={() =>
              this.handleRatingChange(
                3,
                this.state.selectedRating[3] ? false : true
              )
            }
          >
            <Text
              style={[
                styles.ratingNumber,
                this.state.selectedRating[3] === true
                  ? styles.activeRatingText
                  : ""
              ]}
            >
          ...
          <TouchableOpacity
            style={[
              styles.starBox,
              this.state.selectedRating[4] === true ? styles.activeRating : ""
            ]}
            onPress={() =>
              this.handleRatingChange(
                4,
                this.state.selectedRating[4] ? false : true
              )
            }
          >
            <Text
              style={[
                styles.ratingNumber,
                this.state.selectedRating[4] === true
                  ? styles.activeRatingText
                  : ""
              ]}
            >
    ...
    return (
      <View>
        ...
        >
          ...
          >
            <Text>
              {this.props.currencySign} {this.state.priceRange[0]}
            </Text>
            <Text>
              {this.props.currencySign} {this.state.priceRange[1]}
            </Text>
          </View>
          <MultiSlider
  ...
  onSearchPress() {
    ...
    if (params.adults < this.state.count.bedrooms) {
      ...
      arrayRooms = arrayRooms.filter(function(n) {
        return n != undefined;
      });
      ...
      for (var k = 0; k < this.state.count.bedrooms; k++) {
        this.state.rooms.push({ adults: counts[k], children: [] });
      }
    }
