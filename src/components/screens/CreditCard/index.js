          ...
          >
            ...
            <View style={styles.main}>
              <View style={styles.titleView}>
                <Text style={styles.maintitleText}>Card Holder</Text>
              </View>
              ...
              <View style={styles.titleView}>
                <Text style={styles.maintitleText}>Credit Card Details</Text>
              </View>
              <View style={styles.titleView}>
              ...
              >
                <View style={styles.inputhalfView}>
                  <View style={styles.titleHalfView}>
                ...
                <View style={styles.inputhalfView}>
                  <View style={styles.titleHalfView}>
                    <Text style={styles.titleText}>CVV Code</Text>
                  </View>
                  <SmartInput
                    value={CVV}
                    keyboardType="numeric"
