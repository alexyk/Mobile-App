...
export default function InboxMessagesView(props) {
  const messageCreatedAt = moment(
    props.inboxMessage.lastMessage.createdAt,
    "DD/MM/YYYY HH:mm:ss"
  );
  return (
    ...
    <View>
      ...
      <View style={styles.trBottomView}>
        ...
        <Text style={[styles.messageValues]}>
          {props.inboxMessage.lastMessage.message}
        </Text>
