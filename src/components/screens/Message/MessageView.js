...
export default function MessageView(props) {
  ...
  if (props.message.sender.image != "") {
    if (
      props.message.sender.image.indexOf("images/default.png".toLowerCase()) !=
      -1
    ) {
    ...
    return (
      ...
      <View style={styles.rowStyle}>
        ...
        <View style={styles.viewStyle}>
          ...
          <Text style={styles.listChild}>
            {messageCreatedAt > moment().add("-1", "days")
              ? messageCreatedAt.format("HH:mm")
              : messageCreatedAt.format("DD MMM, HH:mm")}
          </Text>
        </View>
      </View>
    );
    ...
    return (
      ...
      <View style={styles.rowStyleSender}>
        <View style={styles.viewStyleSender}>
          ...
          <Text style={styles.listChildSender}>
            {messageCreatedAt < moment().add("-1", "days")
              ? messageCreatedAt.format("HH:mm")
              : messageCreatedAt.format("DD MMM, HH:mm")}
          </Text>
        ...
        <Image style={styles.imageStyleSender} source={imageAvatar} />
      </View>
    );
  }
}
