...
class Favorites extends Component {
  ...
  renderProgressBar() {
    return (
      ...
      >
        <ProgressBarAndroid styleAttr="Inverse" color="#cc8068" />
      </View>
    );
  }
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.title}>
          You don't have any added destinations yet.
        </Text>
        <Text style={styles.subtext}>
          Explore thousands of locations and add your favourites here.
        </Text>
        <TouchableOpacity
          onPress={this.onStartExploring}
      ...
      <View style={styles.container}>
        ...
        <View style={{ width: "100%" }}>
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                onPress={() => this.goToSingleWishList()}
                style={{
              ...
              >
                ...
                >
                  ...
                  <LTIcon
                    textStyle={[styles.subtitle, { fontSize: 8 }]}
                    name={"circle"}
                  />
