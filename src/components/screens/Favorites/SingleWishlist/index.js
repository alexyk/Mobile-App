...
const starEmpty = (
  <LTIcon style={{ fontSize: 15, color: "#8f9191" }} name={"starO"} />
);
const starFill = (
  <LTIcon style={{ fontSize: 15, color: "#bacfc9" }} name={"starO"} />
);
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <Text style={styles.subtTitle}>
          Anytime <LTIcon isText style={{ fontSize: 5 }} name={"circle"} /> 2
          guests
        </Text>
            ...
            renderItem={({ item }) => (
              ...
              >
                <View style={styles.viewForImage}>
                  <Image style={styles.flatListItemImage} source={item.image} />
                  <TouchableOpacity
                    style={{
                      height: 40,
                      width: 30,
                ...
                >
                  ...
                  <Text style={styles.title3}>
                    {item.rating} {starFill} {starFill} {starFill} {starFill}{" "}
                    {starEmpty} {item.reveiws}
                  </Text>
