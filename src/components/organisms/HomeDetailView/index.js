...
class HomeDetailView extends Component {
  ...
  render() {
    ...
    const hasSpaceDetails =
      property_type || guests || size || bathroom || bedrooms;
    return (
      <View style={styles.container}>
        <CardView
          ...
          cornerRadius={0}
        >
          <Text style={styles.topTitleText}>{this.props.title}</Text>
          <View>
          ...
          <View style={[styles.rateViewContainer, { height: ratingHeight }]}>
            ...
            <StarRatings
              ...
              emptyStarImage={
                <Image
                  style={{ width: ratingSize, height: ratingSize }}
              ...
              filledStarImage={
                <Image
                  style={{ width: ratingSize, height: ratingSize }}
                  source={require("../../../assets/png/empty-star-full.png")}
                />
              }
            />
